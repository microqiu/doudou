...
//		} );
		...
		var els = this.fields[0].querySelectorAll('[required]');
		els[0].addEventListener( 'change', function() { if(els[2].checked||els[3].checked||els[4].checked) self._nextField(); } );
		els[1].addEventListener( 'change', function() { if(els[2].checked||els[3].checked||els[4].checked) self._nextField(); } );
		els[2].addEventListener( 'change', function() { if(els[0].checked||els[1].checked) self._nextField(); } );
		els[3].addEventListener( 'change', function() { if(els[0].checked||els[1].checked) self._nextField(); } );
		els[4].addEventListener( 'change', function() { if(els[0].checked||els[1].checked) self._nextField(); } );
	...
	FForm.prototype._nextField = function( backto ) {
		...
		this.isLastStep = this.current === this.fieldsCount - 2 && backto === undefined ? true : false;
...
/*					self._hideCtrl( self.ctrlNav );
					...
					$('input[name=q5]:checked').each(function(){
						question5 += this.value + ',';
					});
					question5 = question5.substring(0,question5.length-1);
					var question6 = $('input[name=q6]:checked').val();
					var question7 = '';
					$('input[name=q7]:checked').each(function(){
						question7 += this.value + ',';
					});
					question7 = question7.substring(0,question7.length-1);
